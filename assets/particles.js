...
var pJS = function(e, a) {
    ...
    i.fn.retinaInit = function() {
        i.retina_detect && window.devicePixelRatio > 1 ? (i.canvas.pxratio = window.devicePixelRatio, i.tmp.retina = true) : (i.canvas.pxratio = 1, i.tmp.retina = false);
    ...
    i.fn.particle = function(e, a, t) {
        if (this.radius = (i.particles.size.random ? Math.random() : 1) * i.particles.size.value, i.particles.size.anim.enable && (this.size_status = false, this.vs = i.particles.size.anim.speed / 100, i.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = t ? t.x : Math.random() * i.canvas.w, this.y = t ? t.y : Math.random() * i.canvas.h, this.x > i.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > i.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), i.particles.move.bounce && i.fn.vendors.checkOverlap(this, t), this.color = {}, "object" == typeof e.value) {
        ...
        i.particles.opacity.anim.enable && (this.opacity_status = false, this.vo = i.particles.opacity.anim.speed / 100, i.particles.opacity.anim.sync || (this.vo = this.vo * Math.random()));
        var n = {};
        ...
        if ("image" == this.shape) {
            ...
            "svg" == i.tmp.img_type && void 0 != i.tmp.source_svg && (i.fn.vendors.createSvgImg(this), i.tmp.pushing && (this.img.loaded = false));
        }
    };
    ...
    i.fn.particlesUpdate = function() {
        for (var e = 0; e < i.particles.array.length; e++) {
            ...
            if (i.particles.opacity.anim.enable && (1 == a.opacity_status ? (a.opacity >= i.particles.opacity.value && (a.opacity_status = false), a.opacity += a.vo) : (a.opacity <= i.particles.opacity.anim.opacity_min && (a.opacity_status = true), a.opacity -= a.vo), a.opacity < 0 && (a.opacity = 0)), i.particles.size.anim.enable && (1 == a.size_status ? (a.radius >= i.particles.size.value && (a.size_status = false), a.radius += a.vs) : (a.radius <= i.particles.size.anim.size_min && (a.size_status = true), a.radius -= a.vs), a.radius < 0 && (a.radius = 0)), "bounce" == i.particles.move.out_mode) {
                var s = {
                    x_left: a.radius,
                    x_right: i.canvas.w,
                    y_top: a.radius,
            ...
            if (i.interactivity.events.onhover.mode.indexOf("grab") > -1 && i.fn.modes.grabParticle(a), (i.interactivity.events.onhover.mode.indexOf("bubble") > -1 || i.interactivity.events.onclick.mode.indexOf("bubble") > -1) && i.fn.modes.bubbleParticle(a), (i.interactivity.events.onhover.mode.indexOf("repulse") > -1 || i.interactivity.events.onclick.mode.indexOf("repulse") > -1) && i.fn.modes.repulseParticle(a), i.particles.line_linked.enable || i.particles.move.attract.enable) {
    ...
    i.fn.modes.pushParticles = function(e, a) {
        ...
        for (var t = 0; e > t; t++) {
            ...
            t == e - 1 && (i.particles.move.enable || i.fn.particlesDraw(), i.tmp.pushing = false);
        }
    };
    ...
    i.fn.modes.bubbleParticle = function(e) {
        ...
        if (i.interactivity.events.onhover.enable && i.interactivity.events.onhover.mode.indexOf("bubble") > -1) {
            ...
            if (i.interactivity.events.onclick.enable && i.interactivity.events.onclick.mode.indexOf("bubble") > -1) {
                if (i.tmp.bubble_clicking) {
                    var s = e.x - i.interactivity.mouse.click_pos_x,
                        n = e.y - i.interactivity.mouse.click_pos_y,
                        r = Math.sqrt(s * s + n * n),
                        p = ((new Date).getTime() - i.interactivity.mouse.click_time) / 1e3;
                    p > i.interactivity.modes.bubble.duration && (i.tmp.bubble_duration_end = true);
                    p > 2 * i.interactivity.modes.bubble.duration && (i.tmp.bubble_clicking = false, i.tmp.bubble_duration_end = false);
                }
    ...
    i.fn.modes.repulseParticle = function(e) {
        ...
        if (i.interactivity.events.onhover.enable && i.interactivity.events.onhover.mode.indexOf("repulse") > -1 && "mousemove" == i.interactivity.status) {
            var t = e.x - i.interactivity.mouse.pos_x,
                ...
                l = Math.min(Math.max(1 / c * (-1 * Math.pow(n / c, 2) + 1) * c * 100, 0), 50),
                v = {
                    x: e.x + r.x * l,
                    y: e.y + r.y * l
                };
            ...
            if (i.interactivity.events.onclick.enable && i.interactivity.events.onclick.mode.indexOf("repulse") > -1) {
                if (i.tmp.repulse_finish || (i.tmp.repulse_count++, i.tmp.repulse_count == i.particles.array.length && (i.tmp.repulse_finish = true)), i.tmp.repulse_clicking) {
    ...
    i.fn.vendors.createSvgImg = function(e) {
        var a = i.tmp.source_svg,
            s = a.replace(/#([0-9A-F]{3,6})/gi, function(a, t, i, s) {
                if (e.color.rgb) {
        ...
        if (i.tmp.img_error = void 0, "" != i.particles.shape.image.src) {
            if ("svg" == e) {
                ...
                a.onreadystatechange = function(e) {
                    4 == a.readyState && (200 == a.status ? (i.tmp.source_svg = e.currentTarget.response, i.fn.vendors.checkBeforeDraw()) : (console.log("Error pJS - Image not found"), i.tmp.img_error = true));
                };
                a.send();
            } else {
                var t = new Image;
...
window.particlesJS = function(e, a) {
    ...
    n.className = "particles-js-canvas-el";
    n.style.width = "100%";
    n.style.height = "100%";
